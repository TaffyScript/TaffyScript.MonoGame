...
namespace TaffyScript.MonoGame.Input.Win32
{
    internal static class NativeMethods
    {
        ...
        /*[DllImport(User32, CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Auto, ExactSpelling = true, PreserveSig = true, SetLastError = true)]
        ...
        [DllImport(User32, CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Auto, ExactSpelling = true, PreserveSig = true, SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool UnregisterDeviceNotification([In] IntPtr handle);*/
