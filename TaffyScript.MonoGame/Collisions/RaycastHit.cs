...
namespace TaffyScript.MonoGame.Collisions
{
    public struct RaycastHit
    {
        ...
        public RaycastHit(Shape shape, float fraction, float distance, Vector2 point, Vector2 normal)
        {
            Shape = shape;
            Fraction = fraction;
            Distance = distance;
        ...
        internal void SetValues(Shape shape, float fraction, float distance, Vector2 point)
        {
            Shape = shape;
            Fraction = fraction;
            Distance = distance;
